...
import com.example.zy_cp.cdsxtnewsapp.gson.News;
import com.example.zy_cp.cdsxtnewsapp.gson.NewsList;
import com.example.zy_cp.cdsxtnewsapp.util.HttpUtil;
import com.example.zy_cp.cdsxtnewsapp.util.Param;
import com.example.zy_cp.cdsxtnewsapp.util.Utility;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* username = (TextView)findViewById(R.id.username);
        username.setText(Param.getSessionName());*/
    ...
    private String response(int itemName){
        String address = "https://api.tianapi.com/social/?key=105936b884640b74bb9c7d0b650a503b&num=50&rand=1";
        switch(itemName){
            case ITEM_SOCIETY:
                break;
            case ITEM_COUNTY:
...
//                address="https://api.tianapi.com/it/?key=339a8b166f397f008236e596616a5f54&num=50&rand=1";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        email.setText(Param.getSessionEmail());
        switch (item.getItemId()){
